...
namespace OKnowTest
{
    ...
    {
		/// <summary>
        /// Tests player score calculations for one player
        ///</summary>
        [TestMethod]
		...
		/// <summary>
        /// Tests player score calculations for multiple player
        ///</summary>
        [TestMethod]
		...
		/// <summary>
        /// Tests player score calculations for multiple players
        ///</summary>
        [TestMethod]
		...
		/// <summary>
        /// Tests player score board calculations for multiple players
        ///</summary>
        [TestMethod]
