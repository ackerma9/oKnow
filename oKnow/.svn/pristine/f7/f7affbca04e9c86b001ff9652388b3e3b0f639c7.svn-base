...
namespace OKnow.Questions
{
    public class VideoGameQuestions
    {
        ...
        public static void addQuestions(QuestionPool pool)
        {
            ...
            pool.addQuestion(Category.VIDEOGAMES, "The Call of Duty Black Ops series is owned by which console publishing company?", choices, Answer.FOUR, QuestionType.STANDARD);
            ...
            Question question = new Question(Category.VIDEOGAMES, "What game does this theme song belong to?", choices, Answer.TWO, QuestionType.MUSIC);
            question.Sound = halo;
