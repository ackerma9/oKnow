...
namespace OKnowTest
{
    ...
    public class GameBoardTest
    {
        ...
        {
            GameBoard board = new GameBoard(20, 5, 1, Category.VIDEOGAMES, BoardSize.SMALL, BoardType.STANDARD);
        ...
        {
            GameBoard board = new GameBoard(20, 5, 2, Category.VIDEOGAMES, BoardSize.SMALL, BoardType.STANDARD);
